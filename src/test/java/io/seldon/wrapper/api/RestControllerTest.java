...
public class RestControllerTest {
	...
	@Autowired
	ModelRestController modelRestController;
    ...
    public void testPredict() throws Exception
    {
    	...
    	MvcResult res = mvc.perform(MockMvcRequestBuilders.get("/predict")
    ...
    public void testFeedback() throws Exception
    {
    	...
    	MvcResult res = mvc.perform(MockMvcRequestBuilders.get("/send-feedback")
    			.accept(MediaType.APPLICATION_JSON_UTF8)
    			.param("json", predictJson)
    			.contentType(MediaType.APPLICATION_JSON_UTF8)).andReturn();
    	String response = res.getResponse().getContentAsString();
